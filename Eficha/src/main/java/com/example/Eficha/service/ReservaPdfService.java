...
public class ReservaPdfService {
        ...
        public byte[] gerarComprovante(Long reservaId) {
                ...
                try {
                        ...
                        adicionarLinha(tabela, "Paciente:", reserva.getPaciente().getNomeCompleto(), subtituloFont,
                                        textoFont);
                        adicionarLinha(tabela, "CPF:", reserva.getPaciente().getCpf(), subtituloFont, textoFont);
                        adicionarLinha(tabela, "Posto de Saúde:", reserva.getPostoSaude().getNome(), subtituloFont,
                                        textoFont);
                        adicionarLinha(tabela, "Endereço:",
                                        reserva.getPostoSaude().getEndereco() + " - "
                                                        + reserva.getPostoSaude().getBairro(),
                        ...
                        String codigoQr = "reserva:" + reserva.getId();

                        QRCodeWriter writer = new QRCodeWriter();
                        BitMatrix matrix = writer.encode(codigoQr, BarcodeFormat.QR_CODE, 150, 150);
